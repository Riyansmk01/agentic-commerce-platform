...
```bash
git remote add encore encore://agentic-commerce-platform-a6zi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/agentic-commerce-platform-a6zi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/agentic-commerce-platform-a6zi/settings/integrations/github)
